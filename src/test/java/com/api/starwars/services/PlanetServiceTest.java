...
public class PlanetServiceTest {
    ...
    @Test
    public void should_return_movies_appearances_quantity_when_find_by_right_name() throws IOException, InterruptedException {
    ...
    @Test
    public void should_return_0_movies_appearances_quantity_when_find_by_wrong_name() throws IOException, InterruptedException {
    ...
    @Test
    public void should_return_all_filled_when_find() throws IOException, InterruptedException {
        when(starWarsApiConsumer.getPlanetBy(RIGHT_PLANET_NAME)).thenReturn(rightPlanetResponseDTO);
    ...
    @Test
    public void should_return_all_empty_when_find() throws IOException, InterruptedException {
    ...
    @Test
    public void should_return_all_paginated_filled_when_find() throws IOException, InterruptedException {
        when(starWarsApiConsumer.getPlanetBy(RIGHT_PLANET_NAME)).thenReturn(rightPlanetResponseDTO);
    ...
    @Test
    public void should_return_all_paginated_empty_when_find() throws IOException, InterruptedException {
    ...
    @Test
    public void should_return_planet_dto_when_find_by_right_id() throws IOException, InterruptedException {
    ...
    @Test
    public void should_return_planet_dto_when_find_by_wrong_id() throws IOException, InterruptedException {
    ...
    @Test
    public void should_return_planet_dto_when_find_by_right_name() throws IOException, InterruptedException {
        PLANET.setId(RIGHT_ID);
        when(starWarsApiConsumer.getPlanetBy(RIGHT_PLANET_NAME)).thenReturn(rightPlanetResponseDTO);
    ...
    @Test
    public void should_return_planet_dto_when_find_by_wrong_name() throws IOException, InterruptedException {
        WRONG_PLANET.setId(WRONG_ID);
