...
class PlanetServiceTest {
    ...
    class FindByName {
        ...
        void fail_when_not_found() throws IOException, InterruptedException {
            ...
            assertThrows(HttpNotFoundException.class, () -> planetService.findByName(FAKE_NAME, 0L));
        }
    }
    ...
    class UpdateById {
        ...
        void fail_when_invalid_fields() {
            ...
            assertThrows(HttpBadRequestException.class, () -> planetService.updateById(FAKE_ID, invalidPlanet));
        }
        ...
        void fail_when_not_found() {
            ...
            assertThrows(HttpNotFoundException.class, () -> planetService.updateById(FAKE_ID, DomainUtils.getRandomPlanet()));
        }
    }
